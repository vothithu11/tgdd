...
function CartButton({dataProduct}:{dataProduct:IProduct}) {
  ...
  return (
    <div className='flex justify-between gap-2 flex-wrap w-full'>
        <button className="text-blue-custom rounded-lg p-2 text-[15px] flex items-center flex-col border w-[209px] h-[50px]" onClick={handleAddCart}>
                                    <FontAwesomeIcon icon={faCartShopping} className="w-4 h-4 text-blue-custom" />
                                    Thêm vào giỏ
                                </button>
                                <Link href='/cart'>
                                <button className="text-white rounded-lg p-2 text-[15px] flex items-center justify-center border w-[209px] h-[50px] bg-[#fc7600] border-[#fc7600]" onClick={handleBuyNow}>
                                    Mua ngay
                                </button>
                                </Link>
                                <button className="text-white rounded-lg p-2 text-[15px] flex items-center flex-col border w-[209px] h-[50px] bg-[#2f80ed]">
