    ...
    return (
        <div>
            {feedBack ? (
                ...
                <span className="w-[55%] p-3 text-[#515764] font-thin text-[13px]">
                    Bạn có hài lòng với trải nghiệm tìm kiếm thông tin, sản phẩm trên website không?
                </span>
                <div className="w-[20%] flex flex-col justify-center items-center gap-1 cursor-pointer" onClick={handleClick}>
                ...
                <div className="w-[25%]  flex flex-col justify-center items-center gap-1 cursor-pointer" onClick={handleClick}>
